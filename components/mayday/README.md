...
Mayday is a multi-agent incident response system that consumes Sitrep snapshots to coordinate automated and human incident response.

## Architecture

Mayday uses specialized AI agents that work together during incidents:
